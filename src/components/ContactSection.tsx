...
export default function ContactSection() {
    ...
    animate-[shine_4s_linear_infinite]"
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* gmail */}
                            <a
                                href="mailto:ansht058@gmail.com"
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    bg-clip-text text-transparent"
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5">
                        {/* Instagram */}
                        <a
                            href="https://www.linkedin.com/in/ansh-thakur-11879a351"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
    ...
    hover:-translate-y-1.5 hover:scale-105 hover:border-white/30"
                        >
                            ...
                            {/* icon */}
                            <FaLinkedin className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-white" />
                        </a>

                        {/* GitHub */}
                        <a
                            href="https://github.com/anshthakur5827"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="GitHub"
                            className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
        ...
        hover:-translate-y-1.5 hover:scale-105 hover:border-red-400/50"
                        >
                            ...
                            <FaEnvelope className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-white" />
                        </a>
        ...
        hover:-translate-y-1.5 hover:scale-105 hover:border-sky-400/50"
                        >
                            ...
                            <FaWhatsapp className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-green-400" />
                        </a>
                    </div>
