...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Building responsive web apps and interactive dashboards on top of
          robust SQL databases. Turning heavy data into clean, usable products.
        </motion.p>
        ...
        >
          {["React.js", "SQL Server", "Power BI", "Tailwind CSS"].map((tech) => (
            <div
              key={tech}
              className="
