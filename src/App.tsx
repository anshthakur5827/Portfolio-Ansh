...
const logos = ["ANSH THAKUR", "FULL-STACK", "DATABASE", "DEVELOPER"];
...
animate-[shine_4s_linear_infinite]">
    ...
    from-white via-white/60 to-white
    animate-[shine_4s_linear_infinite]">
                  Full-stack web developer & database engineer{" "} <br />
                  <em className="not-italic text-white">
                    turning heavy SQL into fast, responsive interfaces.
                  </em>
                </p>
